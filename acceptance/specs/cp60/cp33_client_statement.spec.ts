...
// UPDATED for cp60 (mutates 33): the statement still groups invoices by job and totals discounted
// amounts with commas, now shown in the client's own currency.
