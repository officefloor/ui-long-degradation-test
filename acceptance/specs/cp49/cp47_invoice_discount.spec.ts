...
// UPDATED (sales tax): the invoice detail now also shows tax, and the final total is the discounted
// subtotal plus tax.
test.describe('invoice discount', () => {
  test('shows subtotal, discount, tax and final total', { tag: '@functionality' }, async ({ page }) => {
    await resetAndSeed({
