...
// Third entity + a cross-feature screen: a project's detail page lists ITS invoices and shows a
// derived total. Reuse pressure: an invoices list rendered in the project context, plus a computed
// aggregate. Amounts render with 2 decimals. Open a project via project-open-<id>.
